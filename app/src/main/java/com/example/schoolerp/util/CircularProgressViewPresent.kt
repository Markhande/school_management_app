...
class CircularProgressViewPresent @JvmOverloads constructor(
    context: Context,
    ...
    override fun onDraw(canvas: Canvas) {
        ...
        canvas.drawText("Present", centerX, centerY + textPresent.textSize+textTopMargin, textPresent)
    }
