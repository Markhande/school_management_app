...
class CircularProgressViewAbsent @JvmOverloads constructor(
    context: Context,
    ...
    private val textAbsent = Paint().apply {
        color = 0xFF000000.toInt()
        textSize = 30f
        isAntiAlias = true
        isFakeBoldText =true
    ...
    override fun onDraw(canvas: Canvas) {
        ...
        canvas.drawText("Absent", centerX, centerY + textAbsent.textSize+textTopMargin, textAbsent)
    }
